...
CREATE TABLE "table_section" (
    ...
    CONSTRAINT "table_section_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "order" ADD CONSTRAINT "order_table_section_id_fkey" FOREIGN KEY ("table_section_id") REFERENCES "table_section"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE "table_section" ADD CONSTRAINT "table_section_restaurant_id_fkey" FOREIGN KEY ("restaurant_id") REFERENCES "restaurant"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "table_section" ADD CONSTRAINT "table_section_wait_staff_id_fkey" FOREIGN KEY ("wait_staff_id") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
